...
import type AxiosInstance from '@app/dossier/models/enums/VestibuleTypeFicheEnum';
import type { VestibuleTypeFiche } from '@app/dossier/models/enums/VestibuleTypeFicheEnum';
